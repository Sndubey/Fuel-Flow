<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_dash.aspx.cs" Inherits="F_F.admin_dash" %>
...
<body>
    <form id="form1" runat="server">
        <div class="all">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [Order] WHERE [order_Id] = @order_Id" InsertCommand="INSERT INTO [Order] ([Pro_name], [qty], [date], [time], [address], [postcode], [phone]) VALUES (@Pro_name, @qty, @date, @time, @address, @postcode, @phone)" SelectCommand="SELECT * FROM [Order]" UpdateCommand="UPDATE [Order] SET [Pro_name] = @Pro_name, [qty] = @qty, [date] = @date, [time] = @time, [address] = @address, [postcode] = @postcode, [phone] = @phone WHERE [order_Id] = @order_Id">
                <DeleteParameters>
