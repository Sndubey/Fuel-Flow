<%@ Page Title="" Language="C#" MasterPageFile="~/H.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="F_F.H1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="HP_pg.css" rel="stylesheet" />
    ...
    <div class="cont_flex">
        <div class="product-card">
            ...
            <div class="product-info">
                <h2 class="product-title">Order Diesel</h2>
                <p class="product-description">Get diesel delivered to your doorstep with ease. Simply order online and schedule a convenient time.</p>
                <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Order" OnClick="Button1_Click" />
            </div>
        </div>
        <div class="product-card">
            ...
            <div class="product-info">
                ...
                <asp:Button ID="Button2" CssClass="btn btn-primary" runat="server" Text="Order" OnClick="Button2_Click" />
            </div>
        </div>
        <!-- <div class="product-card">
            ...
            <div class="product-info">
                ...
                <asp:Button ID="Button3" CssClass="btn btn-primary" runat="server" Text="Order" OnClick="Button3_Click" />
            </div>
        </div>-->
    </div>
    <!-- Product Section end -->
