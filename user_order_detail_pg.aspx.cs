...
namespace F_F
{
    public class ProductDataAccess
    {
        ...
        public string GetOrderidByPhone(string phone)
        {
            ...
            {
                connection.Open();
                string query = "SELECT order_id FROM [Order] WHERE phone = @phone";
                SqlCommand cmd = new SqlCommand(query, connection);
        ...
        public string GetDateByPhone(string phone)
        {
            ...
            {
                connection.Open();
                string query = "SELECT date FROM [Order] WHERE phone = @phone";
                SqlCommand cmd = new SqlCommand(query, connection);
                cmd.Parameters.AddWithValue("@phone", phone);
        ...
        public string GetTimeByPhone(string phone)
        {
            ...
            {
                connection.Open();
                string query = "SELECT time FROM [Order] WHERE phone = @phone";
                SqlCommand cmd = new SqlCommand(query, connection);
                cmd.Parameters.AddWithValue("@phone", phone);
        ...
        public string GetQtyByPhone(string phone)
        {
            ...
            {
                connection.Open();
                string query = "SELECT qty FROM [Order] WHERE phone = @phone";
                SqlCommand cmd = new SqlCommand(query, connection);
                cmd.Parameters.AddWithValue("@phone", phone);
        ...
        public string GetProductNameByPhone(string phone)
        {
            ...
            {
                connection.Open();
                string query = "SELECT Pro_name FROM [Order] WHERE phone = @phone";
                SqlCommand cmd = new SqlCommand(query, connection);
                cmd.Parameters.AddWithValue("@phone", phone);
